...
#define SENSOR_CLASS Bh1750<0x23,::BH1750::Mode::ONE_TIME_HIGH_RES_MODE>
//bh1750 //better battery life with ONE_TIME_HIGH_RES_MODE
//#define SENSOR_CLASS Bh1750<0x5c,::BH1750::Mode::CONTINUOUS_LOW_RES_MODE>     bh1750
...
const struct DeviceInfo PROGMEM devinfo = {
  {0x34, 0xfd, 0xF1},     // Device ID
  "HM_SEN_LI_O_1",           // Device Serial
...
class LiList1 : public RegList1<LiReg1> {
  public:
    ...
    void defaults () {
      clear();
      aesActive(false);
      txMindelay(8); //min sende interval 8 seconds, set to 120seconds for better battery life, can be set from FHEM as attribute
